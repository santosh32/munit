...
import org.mule.munit.config.ContainsFilesMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public ContainsFilesDefinitionParser() {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContent) {
        ...
        if ((element.getAttribute("file")!= null)&&(!StringUtils.isBlank(element.getAttribute("file")))) {
