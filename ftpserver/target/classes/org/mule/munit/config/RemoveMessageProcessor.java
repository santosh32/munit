...
/**
 * RemoveMessageProcessor invokes the {@link org.mule.munit.FTPServerModule#remove(java.lang.String)} method in {@link FTPServerModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            String transformedPath = ((String) evaluateAndTransform(_muleMessage, RemoveMessageProcessor.class.getDeclaredField("_pathType").getGenericType(), null, path));
            retryCount.getAndIncrement();
            castedModuleObject.remove(transformedPath);
            retryCount.set(0);
            return event;
        } catch (Exception e) {
