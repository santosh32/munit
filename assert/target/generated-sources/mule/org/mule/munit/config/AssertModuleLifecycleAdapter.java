...
/**
 * A <code>AssertModuleLifecycleAdapter</code> is a wrapper around {@link AssertModule } that adds lifecycle methods to the pojo.
 * 
 */
public class AssertModuleLifecycleAdapter
    extends AssertModuleCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(AssertModuleLifecycleAdapter.class);
