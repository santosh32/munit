...
import org.mule.munit.config.AddExpectedMessageProcessor;
...
public class AddExpectedDefinitionParser     implements BeanDefinitionParser
{
    ...
    public AddExpectedDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(AddExpectedMessageProcessor.class.getName());
