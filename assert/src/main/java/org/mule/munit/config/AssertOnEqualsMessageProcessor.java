...
/**
 * AssertOnEqualsMessageProcessor invokes the {@link org.mule.munit.AssertModule#assertOnEquals(java.lang.String, java.lang.Object, java.lang.Object)} method in {@link AssertModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class AssertOnEqualsMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private Object _expectedType;
    private Object value;
    private Object _valueType;
    private static Logger logger = LoggerFactory.getLogger(AssertOnEqualsMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("assertOnEquals"), event, new RuntimeException("Cannot find the configuration specified by the org.mule.munit.config-ref attribute."));
            }
        } else {
            castedModuleObject = ((AssertModuleLifecycleAdapter) moduleObject);
        }
        try {
            String transformedMessage = ((String) evaluateAndTransform(_muleMessage, AssertOnEqualsMessageProcessor.class.getDeclaredField("_messageType").getGenericType(), null, message));
            Object transformedExpected = ((Object) evaluateAndTransform(_muleMessage, AssertOnEqualsMessageProcessor.class.getDeclaredField("_expectedType").getGenericType(), null, expected));
            Object transformedValue = ((Object) evaluateAndTransform(_muleMessage, AssertOnEqualsMessageProcessor.class.getDeclaredField("_valueType").getGenericType(), null, value));
            retryCount.getAndIncrement();
            castedModuleObject.assertOnEquals(transformedMessage, transformedExpected, transformedValue);
            retryCount.set(0);
            return event;
        } catch (Exception e) {
            throw new MessagingException(CoreMessages.failedToInvoke("assertOnEquals"), event, e);
        }
    }
