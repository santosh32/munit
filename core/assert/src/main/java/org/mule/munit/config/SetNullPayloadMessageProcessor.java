...
/**
 * SetNullPayloadMessageProcessor invokes the {@link org.mule.munit.AssertModule#setNullPayload()} method in {@link AssertModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
public class SetNullPayloadMessageProcessor
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{

    private static Logger logger = LoggerFactory.getLogger(SetNullPayloadMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("setNullPayload"), event, new RuntimeException("Cannot find the configuration specified by the org.mule.munit.config-ref attribute."));
            }
        } else {
        ...
        try {
            ...
            resultPayload = castedModuleObject.setNullPayload();
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("setNullPayload"), event, e);
        }
    }
