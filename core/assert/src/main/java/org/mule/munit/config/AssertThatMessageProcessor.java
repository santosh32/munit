...
/**
 * AssertThatMessageProcessor invokes the {@link org.mule.munit.AssertModule#assertThat(java.lang.String, java.lang.Object, java.lang.Object)} method in {@link AssertModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("assertThat"), event, new RuntimeException("Cannot find the configuration specified by the org.mule.munit.config-ref attribute."));
            }
        } else {
            castedModuleObject = ((AssertModuleLifecycleAdapter) moduleObject);
        }
        try {
            String transformedMessage = ((String) evaluateAndTransform(_muleMessage, AssertThatMessageProcessor.class.getDeclaredField("_messageType").getGenericType(), null, message));
            Object transformedPayloadIs = ((Object) evaluateAndTransform(_muleMessage, AssertThatMessageProcessor.class.getDeclaredField("_payloadIsType").getGenericType(), null, payloadIs));
            Object transformedPayload = ((Object) evaluateAndTransform(_muleMessage, AssertThatMessageProcessor.class.getDeclaredField("_payloadType").getGenericType(), null, "#[payload]"));
            retryCount.getAndIncrement();
            castedModuleObject.assertThat(transformedMessage, transformedPayloadIs, transformedPayload);
            retryCount.set(0);
            return event;
        } catch (Exception e) {
            throw new MessagingException(CoreMessages.failedToInvoke("assertThat"), event, e);
        }
    }
