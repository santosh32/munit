...
/**
 * ExpectMessageProcessor invokes the {@link org.mule.munit.MockModule#expect(java.lang.String, java.util.List, java.lang.Object)} method in {@link MockModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private Object when;
    private String _whenType;
    private Object parameters;
    private List<Object> _parametersType;
    private Object mustReturn;
    private Object _mustReturnType;
    private static Logger logger = LoggerFactory.getLogger(ExpectMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("expect"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            castedModuleObject = ((MockModuleLifecycleAdapter) moduleObject);
        }
        try {
            String transformedWhen = ((String) evaluateAndTransform(_muleMessage, ExpectMessageProcessor.class.getDeclaredField("_whenType").getGenericType(), null, when));
            List<Object> transformedParameters = ((List<Object> ) evaluateAndTransform(_muleMessage, ExpectMessageProcessor.class.getDeclaredField("_parametersType").getGenericType(), null, parameters));
            Object transformedMustReturn = ((Object) evaluateAndTransform(_muleMessage, ExpectMessageProcessor.class.getDeclaredField("_mustReturnType").getGenericType(), null, mustReturn));
            retryCount.getAndIncrement();
            castedModuleObject.expect(transformedWhen, transformedParameters, transformedMustReturn);
            retryCount.set(0);
            return event;
        } catch (Exception e) {
