...
/**
 * ExpectFailMessageProcessor invokes the {@link org.mule.munit.MockModule#expectFail(java.lang.String, java.lang.String)} method in {@link MockModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
    ...
    private Object throwA;
    private String _throwAType;
    private static Logger logger = LoggerFactory.getLogger(ExpectFailMessageProcessor.class);
    /**
     * Module object
     * 
     */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("expectFail"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
            castedModuleObject = ((MockModuleLifecycleAdapter) moduleObject);
        }
        try {
            String transformedWhen = ((String) evaluateAndTransform(_muleMessage, ExpectFailMessageProcessor.class.getDeclaredField("_whenType").getGenericType(), null, when));
            String transformedThrowA = ((String) evaluateAndTransform(_muleMessage, ExpectFailMessageProcessor.class.getDeclaredField("_throwAType").getGenericType(), null, throwA));
            retryCount.getAndIncrement();
            castedModuleObject.expectFail(transformedWhen, transformedThrowA);
            retryCount.set(0);
            return event;
        } catch (Exception e) {
