...
/**
 * ExecuteMessageProcessor invokes the {@link org.mule.munit.DBServerModule#execute(java.lang.String)} method in {@link DBServerModule }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        throws MuleException
    {
        ...
        if (moduleObject instanceof String) {
            ...
            if (castedModuleObject == null) {
                throw new MessagingException(CoreMessages.failedToCreate("execute"), event, new RuntimeException("Cannot find the configuration specified by the config-ref attribute."));
            }
        } else {
        ...
        try {
            ...
            throw new MessagingException(CoreMessages.failedToInvoke("execute"), event, e);
        }
    }
