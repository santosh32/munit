...
public class MunitPlugin extends AbstractUIPlugin {
	...
	private final MunitModel fJUnitModel= new MunitModel();
	...
	private static ImageDescriptor createImageDescriptor(String pathPrefix, String imageName, boolean useMissingImageDescriptor) {
		...
		return createImageDescriptor(MunitPlugin.getDefault().getBundle(), path, useMissingImageDescriptor);
	}
