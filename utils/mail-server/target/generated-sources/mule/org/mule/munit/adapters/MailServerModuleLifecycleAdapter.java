...
/**
 * A <code>MailServerModuleLifecycleAdapter</code> is a wrapper around {@link MailServerModule } that adds lifecycle methods to the pojo.
 * 
 */
@Generated(value = "Mule DevKit Version 3.3.1", date = "2012-11-20T12:38:06-03:00", comments = "Build UNNAMED.1297.150f2c9")
public class MailServerModuleLifecycleAdapter
    extends MailServerModuleMetadataAdapater
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(MailServerModuleLifecycleAdapter.class);
