    ...
    implements Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        try {
            ...
            final String _transformedSql = ((String) evaluateAndTransform(getMuleContext(), event, ExecuteMessageProcessor.class.getDeclaredField("_sqlType").getGenericType(), null, sql));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((DBServerModule) object).execute(_transformedSql);
                }
