...
/**
 * A <code>MPMockModuleLifecycleAdapter</code> is a wrapper around {@link MPMockModule } that adds lifecycle methods to the pojo.
 * 
 */
public class MPMockModuleLifecycleAdapter
    extends MPMockModuleCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(MPMockModuleLifecycleAdapter.class);
